...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 05, 2021 at 04:13 AM
...
(10, '2021_09_29_042056_create_data_siswa_table', 4),
(11, '2021_09_29_071726_create_timestamps_table', 4),
(12, '2021_10_04_073229_add_fto_bukti_to_users', 5);
...
CREATE TABLE `users` (
  ...
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `fto_bukti` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
INSERT INTO `users` (`id`, `name`, `email`, `email_verified_at`, `password`, `no_telp`, `role`, `status`, `remember_token`, `created_at`, `updated_at`, `fto_bukti`) VALUES
(5, 'Gfgfdfgd', 'gfhjhgfd@gmail.com', '2021-10-04 00:49:56', '$2y$10$6h7dwj69lL/5nzXq3qhiQ.7pcqcTV8QD38RAAdSKYyF9J.k1/mROG', '123', 'admin', 'sementara', NULL, '2021-10-04 00:49:56', '2021-10-04 00:49:56', 'logo.png'),
(6, 'Dina', 'din@gmail.com', '2021-10-04 01:30:29', '$2y$10$2y88UAbRc6uUhLo/DSqTJOE.KJ6.rpERaxx8qS.fdHwMfHOqDX3WG', '123', 'admin', 'sementara', NULL, '2021-10-04 01:30:29', '2021-10-04 01:30:29', 'C:\\xampp\\tmp\\php3911.tmp');
